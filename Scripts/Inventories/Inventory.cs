...
namespace RPG.Inventories
{
    ...
    public class Inventory : MonoBehaviour, ISaveable, IPredicateEvaluator
    {
        ...
        // ITEMS SPAWNED ON INVENTORY
        [SerializeField] List<InventoryItem> availableItems;
        ...
        /// <summary>
        /// Remove a number of items from the given item. Will never remove more
        /// that there are.
        /// </summary>
        ...
        public bool? Evaluate(PredicateEnum predicate, string[] parameters)
        {
            switch (predicate)
            {
                case PredicateEnum.HasQuestItem:
